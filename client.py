...
class BitTorrentClient(object):
    def __init__(self, download_dir, torrentfile):
    ...
    def create_files(self):
        download_file_location = os.path.join(self.download_dir, self.torrentfile.filename)
    ...
    def request_piece(self, peer_connection, piece_index, begin, requested_length):
        ...
        peer_connection.send_data(str(piece_message))
    ...
    def send_INTERESTED(self, peer_protocol):
        ...
        peer_connection = self.get_peer_connection(peer_protocol)
        peer_connection.send_data(str(interested_msg))
